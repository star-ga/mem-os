...
```bash
python3 scripts/apply_engine.py P-20260213-001 "${MEM_OS_WORKSPACE:-.}" --dry-run
```

### Apply a Proposal
```bash
python3 scripts/apply_engine.py P-20260213-001 "${MEM_OS_WORKSPACE:-.}"
```

### Rollback to Snapshot
```bash
python3 scripts/apply_engine.py "${MEM_OS_WORKSPACE:-.}" --rollback 20260213-143052
```
