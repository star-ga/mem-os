...
```bash
python3 maintenance/apply_engine.py P-20260213-001 "${MEM_OS_WORKSPACE:-.}" --dry-run
```

### Apply a Proposal
```bash
python3 maintenance/apply_engine.py P-20260213-001 "${MEM_OS_WORKSPACE:-.}"
```

### Rollback to Snapshot
```bash
python3 maintenance/apply_engine.py --rollback 20260213-143052 "${MEM_OS_WORKSPACE:-.}"
```
