#!/usr/bin/env python3
"""mem-os Compaction & GC Engine. Zero external deps.
...
def _load_config(ws: str) -> dict:
    """Load compaction config from mem-os.json."""
...
def main():
    parser = argparse.ArgumentParser(description="mem-os Compaction & GC Engine")
