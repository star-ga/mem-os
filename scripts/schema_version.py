#!/usr/bin/env python3
"""Mem-OS Schema Version Migration. Zero external deps.

Detects workspace schema version from mem-os.json and performs safe,
...
def get_workspace_version(workspace: str) -> str:
    """Read schema version from mem-os.json. Returns '1.0.0' if missing or unreadable."""
...
def _migrate_v1_to_v2(workspace: str) -> None:
    ...
    # Add schema_version to mem-os.json
    config_path = os.path.join(workspace, "mem-os.json")
    config: dict = {}
