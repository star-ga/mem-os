#!/usr/bin/env python3
"""mem-os Bootstrap Corpus — one-time backfill from existing knowledge sources.

Populates the mem-os corpus by scanning:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="mem-os Bootstrap Corpus Backfill")
    parser.add_argument("workspace", help="Path to mem-os workspace")
