#!/usr/bin/env python3
"""Mem OS Integrity Validator (Python, cross-platform).
...
class Validator:
    ...
    def run(self):
        # Workspace detection
        if not os.path.isfile(os.path.join(self.ws, "mem-os.json")):
            print(f"ERROR: No mem-os.json found in '{self.ws}'.")
            print("")
            print("This does not appear to be an initialized mem-os workspace.")
