#!/usr/bin/env python3
"""Mem OS SQLite FTS5 Index — incremental lexical indexing. Zero external deps.
...
DB_REL_PATH = ".mem-os-index/recall.db"
...
def main():
    parser = argparse.ArgumentParser(description="Mem OS SQLite FTS5 Index")
