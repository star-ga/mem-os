"""Thin entry point for mem-os-mcp console script.
...
def main():
    ...
    if os.path.isfile(server_py):
        ...
        print("Error: mcp_server.py not found. Run from the mem-os repository root,")
        print("or use: python3 /path/to/mem-os/mcp_server.py")
        sys.exit(1)
