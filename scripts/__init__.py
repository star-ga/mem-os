# Mem OS — Memory + Immune System for AI agents
# Package: mem_os (maps to scripts/ via pyproject.toml package-dir)

"""mem-os: governance-aware memory layer for AI agents.
